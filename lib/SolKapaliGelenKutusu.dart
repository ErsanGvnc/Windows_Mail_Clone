// ignore_for_file: file_names, use_key_in_widget_constructors, unused_local_variable, prefer_const_constructors, avoid_print, prefer_final_fields, prefer_const_literals_to_create_immutables, unused_element, sized_box_for_whitespace

import 'package:flutter/material.dart';
import 'package:mail/main.dart';

class SolKapaliGelenKutusu extends StatefulWidget {
  @override
  _SolKapaliGelenKutusuState createState() => _SolKapaliGelenKutusuState();
}

class _SolKapaliGelenKutusuState extends State<SolKapaliGelenKutusu> {
  //////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
  ...
  Color backcolor17 = Colors.transparent;

  void _unhover17(PointerEvent details) {
    setState(() {
      backcolor17 = Colors.transparent;
    });
  }
  ...
  Color backcolor18 = Colors.transparent;

  void _unhover18(PointerEvent details) {
    setState(() {
      backcolor18 = Colors.transparent;
    });
  }
  ...
  Color backcolor19 = Colors.transparent;

  void _unhover19(PointerEvent details) {
    setState(() {
      backcolor19 = Colors.transparent;
    });
  }
  ...
  Color backcolor20 = Colors.transparent;

  void _unhover20(PointerEvent details) {
    setState(() {
      backcolor20 = Colors.transparent;
    });
  }
      ...
      drawer: Container(
        ...
        child: Drawer(
          child: Container(
            ...
            color: Colors.brown.shade900.withOpacity(0.99),
            child: Stack(
              children: [
